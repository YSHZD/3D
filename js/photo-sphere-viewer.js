...
function PhotoSphereViewer(options) {
  ...
  this.prop = {
    ...
    move_speed: 0.2, // move speed (computed with pixel ratio and config move_speed)
...
PhotoSphereViewer.prototype._transition = function(texture, position) {
  ...
  if (position) {
    ...
    var axis = new THREE.Vector3(0, 0, 0).cross(this.camera.getWorldDirection()).normalize();
